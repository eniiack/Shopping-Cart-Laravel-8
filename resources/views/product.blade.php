        ...
        <div class="col-12">
            <div class="breadcrumb-container">
                <ul class="js-breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="#" class="breadcrumb-link">گوشی موبایل</a>
                    </li>
                    <li class="breadcrumb-item">
                        <a href="#" class="breadcrumb-link active-breadcrumb">گوشی موبایل سامسونگ مدل Galaxy A50s
                            SM-A507FN/DS دو سیم کارت ظرفیت 128گیگابایت</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="comments-product-row">
                        <div class="col-lg-4 col-md-4 col-xs-12 pull-right">
                            <div class="comments-product-col-gallery mt-5 pt-3 text-center">
                                <a href="#">
                                    <img src="/images/single/slider-product/A50s.jpg" style="max-width: 100%;">
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="comments-product-col-info">
                                <div class="comments-product-headline">
                                    <h3 class="comments-product-title">
                                        گوشی موبایل سامسونگ مدل Galaxy A50s SM-A507FN/DS دو سیم کارت ظرفیت 128گیگابایت
                        ...
                        <hr>
                       @include('comments' , ['comments' => $product->comments()->where('parent_id', 0)->get()])
                    </div>
                </div>
            </section>
        </div>
